...
Below are some basic equivalences demonstrating partial moments role as
...
The first 4 moments are returned with the function `NNS.moments`. For
...
`NNS.mode` offers support for discrete valued distributions as well as
...
![](NNSvignette_02_Partial_Moments_files/figure-html/cdfs-1.png)
...
![](NNSvignette_02_Partial_Moments_files/figure-html/cdfs-2.png)
...
![](NNSvignette_02_Partial_Moments_files/figure-html/cdfs-3.png)
...
- [Bayes’ Theorem From Partial
  Moments](https://doi.org/10.2139/ssrn.3457377)
