...
Chapters 17 and 18 established the recursive mean-split estimator as a **partition-based nonparametric regression method** and showed that, under standard regularity conditions, it is consistent for the true conditional mean function.
...
As Chapter 17 emphasized, connecting regression points by line segments yields a piecewise-linear representation.  
...
Chapters 17 and 18 then showed that recursive mean splitting uses benchmark-relative geometry to define estimation regions and produces a consistent estimator.
