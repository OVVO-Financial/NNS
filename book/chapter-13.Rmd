...
\[
1 =
\underbrace{\texttt{Co.UPM}(0,X,Y,t_X,t_Y)}_{P(X>t_X,\,Y>t_Y)}
+\;
\underbrace{\texttt{D.UPM}(0,0,X,Y,t_X,t_Y)}_{P(X>t_X,\,Y\le t_Y)}
+\;
\underbrace{\texttt{D.LPM}(0,0,X,Y,t_X,t_Y)}_{P(X\le t_X,\,Y>t_Y)}
+\;
\underbrace{\texttt{Co.LPM}(0,X,Y,t_X,t_Y)}_{P(X\le t_X,\,Y\le t_Y)}.
\]
