...
Conditional intervals derived from `NNS.reg` are developed in detail in Chapter 22, where the regression estimator is introduced formally and interpreted geometrically.
