...
Chapter 22 developed nonparametric regression in the NNS framework as conditional expectation estimation by recursive partitioning. There, the response variable was numeric, and the objective was to recover a conditional mean surface.
...
The NNS approach to classification begins from the recursive partition machinery introduced in Chapters 19–22.
