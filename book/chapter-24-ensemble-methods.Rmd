...
Chapters 21–23 developed the machine-learning side of the NNS framework from three complementary angles.

- Chapter 21 treated recursive partitions as an unsupervised clustering device.
- Chapter 22 used those same partitions for conditional expectation estimation.
- Chapter 23 used them for local conditional probability estimation and classification.
...
- Chapter 21 used recursive partitions for **unsupervised grouping**.
- Chapter 22 used them for **numeric prediction**.
- Chapter 23 used them for **categorical prediction**.
