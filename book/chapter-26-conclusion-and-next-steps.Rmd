...
**Finite-sample relevance under non-normality.** Partial moments are not merely conceptually distribution-free. They also provide a plausible route to improved stability when the underlying data are skewed, heavy-tailed, or otherwise asymmetric.
...
- **Finite-sample theory for severity-weighted thresholds**: sharper nonasymptotic guarantees for higher-degree threshold estimators remain to be developed.
- **Directional probability bounds under dependence**: extending semivariance-based and partial-moment-based bounds rigorously beyond i.i.d. settings is a natural next step.
- **Threshold degree selection**: formal rules for matching degree choice to decision cost, asymmetry, and intervention timing remain an open problem.
- **Benchmark selection**: since partial moments are benchmark-relative by construction, principled methods for choosing benchmarks across forecasting, operations, policy, and engineering remain an important research frontier.
