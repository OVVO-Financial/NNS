...
6. **Assess finite-sample stability and sample-size sensitivity.**  
   Implement the sample-size sensitivity diagnostics from Section 17.7 using the **Maximum Entropy Bootstrap** workflow developed in Chapter 18, especially when threshold rules feed larger decision or optimization systems.
...
Chapter 18 then supplies the synthetic-data and Maximum Entropy Bootstrap machinery used to operationalize these stability checks, after which Chapter 19 returns to recursive mean-split estimation for adaptive nonparametric regression.
