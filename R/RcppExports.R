...
NNS_dep_pair_cpp <- function(x, y, quad_xy, quad_yx, asym = FALSE) {
    .Call(`_NNS_NNS_dep_pair_cpp`, x, y, quad_xy, quad_yx, asym)
}

NNS_dep_matrix_cpp <- function(X, asym = FALSE) {
    .Call(`_NNS_NNS_dep_matrix_cpp`, X, asym)
}
...
NNS_distance_path_single_parallel_cpp <- function(RPM, yhat, Xtest, k, is_class, nthreads = -1L) {
