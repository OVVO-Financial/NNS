...
x <- sample(1:1000000, 100000, replace=TRUE)
x <- x/max(x)
...
LPM_v <- Vectorize(LPM, vectorize.args = 'target')

sourceCpp(file="C:/Users/rspadim/Documents/teste_nns_rcpp/partial_moments_rcpp.cpp", rebuild=TRUE)

LPM_Cv <- Vectorize(LPM_C, vectorize.args = 'target')

microbenchmark::microbenchmark(
  LPM_v(  0,c(0,1,2,3,4,5),x),
  LPM_Cv( 0,c(0,1,2,3,4,5),x),
  LPM_CPv(0,c(0,1,2,3,4,5),x),
  times=10000
)

LPM_v(  1,c(0,.1,.2,.3,.4,.5),x)
LPM_CPv(1,c(0,.1,.2,.3,.4,.5),x)
...
sourceCpp(file="C:/Users/rspadim/Documents/teste_nns_rcpp/partial_moments_rcpp.cpp", rebuild=TRUE)
NNS::Co.UPM(degree.x=1, degree.y=1, x=x, y=y, target.x=mean(x), target.y=mean(y))
CoUPM_C(degree_x=1, degree_y=1, x=x, y=y, target_x=mean(x), target_y=mean(y))
NNS::Co.LPM(degree.x=1, degree.y=1, x=x, y=y, target.x=mean(x), target.y=mean(y))
CoLPM_C(degree_x=1, degree_y=1, x=x, y=y, target_x=mean(x), target_y=mean(y))
NNS::D.UPM(degree.x=1, degree.y=1, x=x, y=y, target.x=mean(x), target.y=mean(y))
DUPM_C(degree_x=1, degree_y=1, x=x, y=y, target_x=mean(x), target_y=mean(y))
NNS::D.LPM(degree.x=1, degree.y=1, x=x, y=y, target.x=mean(x), target.y=mean(y))
DLPM_C(degree_x=1, degree_y=1, x=x, y=y, target_x=mean(x), target_y=mean(y))
...
sourceCpp(file="C:/Users/rspadim/Documents/teste_nns_rcpp/partial_moments_rcpp.cpp", rebuild=TRUE)
NNS::Co.UPM(degree.x=1, degree.y=1, x=x, y=y, target.x=c(0,mean(x),1), target.y=c(0,mean(y),1))
CoUPM_CPv(degree_x=1, degree_y=1, x=x, y=y, target_x=c(0,mean(x),1), target_y=c(0,mean(y),1))
NNS::Co.LPM(degree.x=1, degree.y=1, x=x, y=y, target.x=c(0,mean(x),1), target.y=c(0,mean(y),1))
CoLPM_CPv(degree_x=1, degree_y=1, x=x, y=y, target_x=c(0,mean(x),1), target_y=c(0,mean(y),1))
NNS::D.UPM(degree.x=1, degree.y=1, x=x, y=y, target.x=c(0,mean(x),1), target.y=c(0,mean(y),1))
DUPM_CPv(degree_x=1, degree_y=1, x=x, y=y, target_x=c(0,mean(x),1), target_y=c(0,mean(y),1))
NNS::D.LPM(degree.x=1, degree.y=1, x=x, y=y, target.x=c(0,mean(x),1), target.y=c(0,mean(y),1))
DLPM_CPv(degree_x=1, degree_y=1, x=x, y=y, target_x=c(0,mean(x),1), target_y=c(0,mean(y),1))
