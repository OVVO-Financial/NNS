...
#' \item{\code{"Robust Certainty Estimate"}} and \code{"95 CI"} are the robust certainty estimate and its 95 percent confidence interval after permutations if \code{robust = TRUE}.
#' }
#'
