...
7. Simulation (max‑entropy) & Monte Carlo
...
See NNS Vignette: [Getting Started with NNS: Normalization and Rescaling](https://cran.r-project.org/web/packages/NNS/vignettes/NNSvignette_Normalization_and_Rescaling.html)
