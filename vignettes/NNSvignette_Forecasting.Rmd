...
## Testing All Combinations of `seasonal.factor`
NNS also offers a wrapper function `NNS.ARMA.optim()` to test a given vector of `seasonal.factor` and returns the lowest SSE and the optimal periods, as well as the `NNS.ARMA` regression method used.
