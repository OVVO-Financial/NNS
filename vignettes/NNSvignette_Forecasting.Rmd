...
## `$bias.shift`
`NNS.ARMA.optim` will return a `$bias.shift`, which is to be added to the ultimate `NNS.ARMA` forecast when using the optimum parameters from the `NNS.ARMA.optim` call.  Note the difference in results...
