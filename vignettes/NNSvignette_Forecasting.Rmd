...
NNS also offers a wrapper function `NNS.ARMA.optim()` to test a given vector of `seasonal.factor` and returns the lowest SSE and the optimal periods.

Given our monthly dataset, we will try multiple years by setting `seasonal.factor=seq(12,60,12)`
