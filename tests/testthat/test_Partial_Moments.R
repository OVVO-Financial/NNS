...
test_that(
	"D.LPM", {
        ...
        expect_equal(D.LPM(0, 2, x, y, mean(x), mean(y)), 0.02248309, tolerance=1e-5)
        expect_equal(D.LPM(2, 0, x, y, mean(x), mean(y)), 0.01727327, tolerance=1e-5)
        ...
        expect_equal(D.LPM(0, 1, x_df, y_df, colMeans(x_df), colMeans(y_df)), 0.06404049, tolerance=1e-5)
        expect_equal(D.LPM(1, 0, x_df, y_df, colMeans(x_df), colMeans(y_df)), 0.05311669, tolerance=1e-5)
        expect_equal(D.LPM(1, 1, x_df, y_df, colMeans(x_df), colMeans(y_df)), 0.01513793, tolerance=1e-5)
        expect_equal(D.LPM(0, 2, x_df, y_df, colMeans(x_df), colMeans(y_df)), 0.02248309, tolerance=1e-5)
        expect_equal(D.LPM(2, 0, x_df, y_df, colMeans(x_df), colMeans(y_df)), 0.01727327, tolerance=1e-5)
